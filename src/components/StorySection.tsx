...
export const StorySection = () => {
  return (
    <div className="w-full max-w-full overflow-hidden flex flex-col gap-14 p-12 items-center bg-[#FEFAF4]">
      <div
        data-aos="zoom-in"
        className="text-3xl font-semibold text-[#8B5E3C] font-merriweather text"
      >
        Hành Trình Gieo Chữ
      </div>
      {/* Story 1 */}
